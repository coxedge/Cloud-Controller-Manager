...
type EdgeNodeSpec struct {
	...
	// Foo is an example field of EdgeNode. Edit edgenode_types.go to remove/update
	CoxEdgeOrganizationId  string `json:"coxEdgeOrganizationId,omitempty"`
	CoxEdgeEnvironmentName string `json:"coxEnvironmentName,omitempty"`
	CoxEdgeImage           string `json:"coxEdgeImage,omitempty"`
	CoxEdgeStackId         string `json:"coxEdgeStackId,omitempty"`
	CoxEdgePrivateIp       string `json:"coxEdgePrivateIp,omitempty"`
	CoxEdgePublicIp        string `json:"coxEdgePublicIp,omitempty"`
}
